...
$images = loadImages('../Galleria/EventiReligiosi/bin/images/large');


$menu = '<div id="mobile_menu" class="mobile_Navigation">
        <a href="../">Home</a> &raquo;
		<a href="Events_meetings_conferences.htm">Events</a> &raquo;
...
<div xmlns:v="http://rdf.data-vocabulary.org/#" id="bread_crumbs" class="PC_Navigation">
		...
		<span typeof="v:Breadcrumb"><a href="Events_meetings_conferences.htm" rel="v:url" property="v:title">Events</a></span> &raquo;
        <span typeof="v:Breadcrumb"><span href="." rel="v:url" property="v:title">Religious Events</span></span>
...
setUpSlideShow($images, 'en', 'Religious Events Photos', '', $menu );
?>